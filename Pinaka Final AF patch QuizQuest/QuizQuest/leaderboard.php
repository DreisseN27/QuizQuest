...
if ($role === "teacher") {
    ...
    // ✅ Student leaderboard MUST be based on student_classes ONLY
    $stmt = $mysqli->prepare("
        SELECT 
            c.id AS class_id,
            c.title,
            ...
            c.class_code,
            c.created_at,
            COUNT(DISTINCT sq.id) AS quizzes_taken
        FROM student_classes sc
        INNER JOIN classes c 
            ON UPPER(c.class_code) = UPPER(sc.class_code)
        LEFT JOIN quizzes q 
                ...
                <div class="card subject-card h-100 leaderboard-card"
                    ...
                    <div class="card-body d-flex flex-column">
                        <div class="d-flex justify-content-between align-items-start mb-2">
                            <h5 class="card-title mb-0"><?= htmlspecialchars($class['title']) ?>
</h5>
